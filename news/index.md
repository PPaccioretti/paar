...
- New `cbind.paar` function to bind the condition of one paar object
  with a `data.frame` or `sf` object.
- Changed `summary.paar` removing the print function.
- Added `print.summary.paar` function to print the summary of a paar
  object.
